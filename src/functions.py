...
def game_menu():
    ...
    game.menu.display_text(game.menu.title_font, "Space Rivals", 110, 180, game.menu.default_color)
    game.menu.display_text(game.menu.option_font, "Play", 145, 280, game.menu.play_color)
    game.menu.display_text(game.menu.option_font, "Exit", 145, 330, game.menu.exit_color)
...
def movable_objects():
    ...
    if 750 < game.score <= 1500:
        ...
        for iteration in range(meteor.quantity):
    ...
    if 1500 < game.score:
        ...
        instead of one '''
        for iteration in range(meteors.quantity):
